...
_G.packer_plugins = {
  ...
  ["friendly-snippets"] = {
    after = { "vim-dadbod-completion", "cmp-calc", "nvim-cmp", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-buffer" },
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'bullets.vim', 'vim-pandoc-syntax', 'vim-pandoc'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType pandoc ++once lua require("packer.load")({'bullets.vim', 'vim-pandoc-syntax', 'vim-pandoc'}, { ft = "pandoc" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'bullets.vim', 'friendly-snippets', 'nvim-autopairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
