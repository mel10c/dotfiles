...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "cmp-path", "cmp-buffer", "cmp-calc", "lspsaga.nvim", "cmp-nvim-lua", "vim-dadbod-completion" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-pandoc', 'bullets.vim', 'vim-table-mode', 'vim-pandoc-syntax', 'ultisnips'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType tex ++once lua require("packer.load")({'cmp-latex-symbols', 'vimtex', 'ultisnips'}, { ft = "tex" }, _G.packer_plugins)]]
vim.cmd [[au FileType pandoc ++once lua require("packer.load")({'vim-pandoc', 'bullets.vim', 'vim-table-mode', 'vim-pandoc-syntax', 'ultisnips'}, { ft = "pandoc" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'vim-surround', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
