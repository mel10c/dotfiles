...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "vim-dadbod-completion", "nvim-autopairs", "cmp-buffer", "cmp-nvim-lua", "cmp-calc", "lspsaga.nvim" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au FileType pandoc ++once lua require("packer.load")({'vim-pandoc', 'vim-pandoc-syntax', 'vim-table-mode', 'bullets.vim', 'ultisnips'}, { ft = "pandoc" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType tex ++once lua require("packer.load")({'vimtex', 'ultisnips', 'cmp-latex-symbols'}, { ft = "tex" }, _G.packer_plugins)]]
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-pandoc', 'vim-pandoc-syntax', 'vim-table-mode', 'bullets.vim', 'ultisnips'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-surround', 'wildfire.vim', 'Comment.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'which-key.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
