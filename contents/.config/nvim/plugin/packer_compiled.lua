...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "lspsaga.nvim", "cmp-nvim-lua", "cmp-buffer", "nvim-autopairs" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'bullets.vim', 'ultisnips', 'vim-pandoc-syntax', 'vim-pandoc', 'vim-table-mode'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType pandoc ++once lua require("packer.load")({'bullets.vim', 'ultisnips', 'vim-pandoc-syntax', 'vim-pandoc', 'vim-table-mode'}, { ft = "pandoc" }, _G.packer_plugins)]]
