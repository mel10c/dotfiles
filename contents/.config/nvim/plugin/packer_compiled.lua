...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "vim-dadbod-completion", "cmp-buffer", "cmp-calc", "cmp-nvim-lua", "cmp-path", "nvim-autopairs" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'ultisnips', 'bullets.vim', 'vim-pandoc', 'vim-pandoc-syntax'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType java ++once lua require("packer.load")({'ultisnips'}, { ft = "java" }, _G.packer_plugins)]]
vim.cmd [[au FileType pandoc ++once lua require("packer.load")({'ultisnips', 'bullets.vim', 'vim-pandoc', 'vim-pandoc-syntax'}, { ft = "pandoc" }, _G.packer_plugins)]]
vim.cmd [[au FileType tex ++once lua require("packer.load")({'ultisnips', 'vimtex'}, { ft = "tex" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-matchup', 'plenary.nvim', 'dashboard-nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'vim-surround', 'nvim-treesitter', 'wildfire.vim'}, { event = "BufRead *" }, _G.packer_plugins)]]
