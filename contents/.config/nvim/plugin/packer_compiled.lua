...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lua", "lspsaga.nvim", "nvim-autopairs" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'vim-surround', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
