...
syn match mdMathSymbol '\\geqslant\>' contained conceal cchar=⩾
syn match mdMathSymbol '\\leqslant\>' contained conceal cchar=⩽
...
syn match mdMathSymbol '\\mathbb{\s*M\s*}' contained conceal cchar=𝕄
...
syn match mdMathSymbol '\\mathbb{\s*U\s*}' contained conceal cchar=𝕌
syn match mdMathSymbol '\\mathbb{\s*V\s*}' contained conceal cchar=𝕍
syn match mdMathSymbol '\\mathbb{\s*W\s*}' contained conceal cchar=𝕎
